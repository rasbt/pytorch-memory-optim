...
if __name__ == "__main__":
    ...
    auto_wrap_policy = partial(size_based_auto_wrap_policy, module={EncoderBlock}, min_num_params=2_000_000)
    strategy = FSDPStrategy(auto_wrap_policy=auto_wrap_policy)

    fabric = Fabric(accelerator="cuda", devices=4, strategy=strategy, precision="16-mixed")
    fabric.launch()
